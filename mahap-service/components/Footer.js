      ...
      <div className="container-xl">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-16 pb-16 border-b border-white/8">
          <ScrollReveal variant="fadeRight" className="md:col-span-5">
            <Link href="/" className="inline-flex items-center gap-3 mb-6 group">
              <div className="relative w-10 h-10 rounded-lg overflow-hidden bg-white">
                <Image src="/images/mahap.png" alt="Mahap Service" width={40} height={40} className="object-contain" />
              </div>
              <div className="flex flex-col">
                <span className="font-bold text-white text-base leading-tight">Mahap Service</span>
                <span className="text-[0.625rem] font-medium text-white/60 tracking-wide uppercase leading-tight">
          ...
          <ScrollReveal variant="fadeUp" delay={0.1} className="md:col-span-3">
            <p className="text-[0.6875rem] font-bold tracking-[0.14em] uppercase text-white/50 mb-5">Navegação</p>
          ...
          <ScrollReveal variant="fadeLeft" delay={0.2} className="md:col-span-4">
            <p className="text-[0.6875rem] font-bold tracking-[0.14em] uppercase text-white/50 mb-5">Contacto</p>
            <address className="not-italic text-sm text-white/70 space-y-3 leading-relaxed">
              ...
              <span className="block text-white/50 text-xs leading-relaxed pt-1">
